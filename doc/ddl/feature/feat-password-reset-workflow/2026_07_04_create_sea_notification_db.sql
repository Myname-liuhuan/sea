-- ================================================================
-- sea_notification 库 - 通知三通道基础表（模板 / 投递日志 / 站内信）
-- 重置密码工单化（M1）
-- ================================================================

CREATE DATABASE IF NOT EXISTS sea_notification CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE sea_notification;

-- ---------------------------------------------------------------
-- 1. notify_template - 通知模板（按 code+version+profile 三元组维护）
-- ---------------------------------------------------------------
